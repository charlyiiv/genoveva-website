    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative px-6 py-24 text-center">
        ...
        <p className="mt-8 max-w-3xl mx-auto text-xl text-slate-400">
          Own a 1/8 share in one of the best managed yacht syndicates in Majorca
          and enjoy six weeks per year aboard a stunning Fairline Squadron 58.
        </p>
      ...
      <section className="py-20 px-6 text-center">
        <h2 className="text-4xl font-bold mb-8">Contact Darrell</h2>
        ...
        <p className="mt-8 text-2xl">07799 733587</p>

        <p className="mt-4 text-slate-400">
          Viewings, ownership details and syndicate information available on
          request.
        </p>
      </section>
    </main>
